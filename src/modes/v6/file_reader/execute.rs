...
use crate::core::sender::{send_file_reader_v6};
    ...
    fn execute(&self){
        ...
        let receiver_res;
        {
            ...
            receiver_res = thread::spawn(move || {
                PcapReceiver::run_v6_hash(0, base_conf, receiver_conf, probe,
                                     tar_num, sports,
            ...
            for assigned_targets in self.assigned_target_range.iter() {
                ...
                if let Some(target_iter) = target_iter_option {
                    ...
                    let sender_thread = thread::spawn(move || {
                        send_file_reader_v6(0, target_iter,
        ...
        if let Ok(receiver_info) = receiver_res.join() {
            ...
            if let Some(summary_path) = &self.base_conf.summary_file {
                ...
                write_record("V6FileReader", "result", summary_path, header, val);
            }
        } else {
