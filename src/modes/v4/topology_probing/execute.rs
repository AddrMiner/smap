    ...
    fn execute(&self) {
        ...
        // 对 所有目标地址 进行探测, 取得 所有存活目标 的 跳数 和 延迟
        {
            ...
            }
            {
                ...
                // 获取 预扫描的多线程任务分配列表
                let tar_ranges = TarIterBaseConf::cycle_group_assign_targets_u64(
                    self.tar_iter.p_sub_one, self.sender_conf.send_thread_num as u64);
                ...
                for tar_range in tar_ranges.iter() {
                    // 发送线程 数据准备
