...
impl IPv6PortSpaceTree {
    ...
    pub fn gen_addrs(&mut self, cur_budget:u64, aliased_prefixes:&AHashSet<u64>, open_addrs_ports:&AHashMap<u128, u16>, max_port_num:u16) -> Vec<(Vec<u8>, u16, u128)> {
        ...
        for i in 0..cur_extra_region_num {
            ...
            for &tar in &cur_tars_set {
                ...
                if let Some(ports_num) = open_addrs_ports.get(&tar_ip) {
