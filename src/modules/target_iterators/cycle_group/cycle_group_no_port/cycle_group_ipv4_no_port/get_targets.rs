use crate::modules::target_iterators::cycle_group::cycle_group_no_port::cycle_group_ipv4_no_port::CycleIpv4NoPort;
...
impl CycleIpv4NoPort {
    ...
    pub fn get_first_ip_port(&mut self) -> (bool, bool, u32) {
    ...
    /// 获取下一个目标的 ip
    /// 返回值: 0:是否为<u>非最终值</u>, 1:最终值是否有效, 2:ip地址
    pub fn get_next_ip_port(&mut self) -> (bool, bool, u32) {
