use crate::modules::target_iterators::cycle_group::cycle_group_no_port::cycle_group_ipv6_pattern_no_port::CycleIpv6PatternNoPort;

impl CycleIpv6PatternNoPort {
    ...
    #[inline]
    pub fn get_real_ip_from_tar_val(&self, ip_val: u128) -> u128 {
