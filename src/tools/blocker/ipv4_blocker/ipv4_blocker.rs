...
impl Ipv4Blocker {
    ...
    fn sort(&mut self){
        ...
        quick_sort_reverse_v4(&mut self.right_move_len, &mut self.prefix_val,
                           0, right_index);
...
/// 注意:两个向量的最大长度为 32, 这里使用i32是考虑性能因素
fn quick_sort_reverse_v4(arr:&mut Vec<u32>,index:&mut Vec<AHashSet<u32>>,left:i32, right:i32){
    ...
    if left < right {
        ...
        quick_sort_reverse_v4(arr, index, left, (i as i32)-1);
        quick_sort_reverse_v4(arr, index, (j as i32)+1, right);
    }
}
