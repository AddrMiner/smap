...
fn quick_sort_reverse_v4(arr:&mut Vec<u32>,index:&mut Vec<AHashSet<u32>>,left:usize, right:usize){
    ...
    if left < right {
        ...
        quick_sort_reverse_v4(arr, index, left, i-1);
        quick_sort_reverse_v4(arr, index, j+1, right);
    }
}
