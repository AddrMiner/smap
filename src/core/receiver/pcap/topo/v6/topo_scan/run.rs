...
impl PcapReceiver {
    ...
    pub fn topo_scan_v6(
        ...
        probe_mod:Arc<TopoModV6>, sports:Vec<u16>, mut state_chain:TopoStateChainV6,
        ...
        for packet in receiver.active_capture.iter(Codec) {
            ...
            match packet {
                ...
                Ok(packet) => {
                    ...
                    if ip_ver == 6 {
                        // 如果是ipv6的数据包
                        PcapReceiver::topo_scan_handle_packet_v6(&header.ts, &net_layer_data, &mut state_chain,
