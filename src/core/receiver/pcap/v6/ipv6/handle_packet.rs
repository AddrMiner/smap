...
impl PcapReceiver  {
    ...
    pub fn handle_packet_v6(header:&PacketHeader, data_link_header:&[u8], _data_link_len:u32,net_layer_header_and_data:&[u8],
                            aes_rand:&AesRand, bit_map:&mut BitMapV6Port, receiver_info:&mut ReceiverInfoV6,
