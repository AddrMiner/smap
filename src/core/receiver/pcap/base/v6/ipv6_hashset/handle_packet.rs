...
impl PcapReceiver  {
    ...
    #[inline]
    pub fn handle_packet_v6_hash(header:&PacketHeader, data_link_header:&[u8], net_layer_header_and_data:&[u8],
                            aes_rand:&AesRand, hash_set:&mut AHashSet<u128>, receiver_info:&mut ReceiverInfoV6, allow_no_succ:bool,
