...
impl PcapReceiver  {
    ...
    #[allow(dead_code)]
    #[inline]
    pub fn handle_packet_v4_hash(header:&PacketHeader, data_link_header:&[u8], net_layer_header_and_data:&[u8],
                            aes_rand:&AesRand, hash_set:&mut AHashSet<u32>, receiver_info:&mut ReceiverInfoV4, allow_no_succ:bool,
