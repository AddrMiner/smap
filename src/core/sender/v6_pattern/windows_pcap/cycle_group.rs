...
pub fn send_cycle_group_v6_pattern(interface_index:usize,
                           mut target_iter:CycleIpv6Pattern, local_tar_ip_num:u64,
    ...
    // 初始化 PID速率控制器
    let mut rate_controller = RateController::from_conf(&sender_conf.global_rate_conf, local_tar_ip_num, batch_size as f64);
