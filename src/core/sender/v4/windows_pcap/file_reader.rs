...
pub fn send_file_reader_v4(interface_index:usize,
                           mut target_iter:Ipv4FileReader,
    ...
    let mut cur_target = target_iter.get_next_ip_port_v4();
    ...
    'big_batch:loop {
        ...
        for _ in 0..batch_size {
            ...
            if cur_target.0 {
                ...
                // 获取下一个目标
                cur_target = target_iter.get_next_ip_port_v4();
            } else {
                // 如果是最终值
