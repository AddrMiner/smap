...
use crate::modules::target_iterators::Ipv6FileReader;
use net::Ipv6Addr;
...
target_os = "ios",
target_os = "linux"))]
pub fn send_file_reader_v6(interface_index:usize,
                           mut target_iter:Ipv6FileReader,
    ...
    let mut cur_target = target_iter.get_next_ip_port_v6();
    ...
    'big_batch:loop {
        ...
        for _ in 0..batch_size {
            ...
            if cur_target.0 {
                ...
                // 获取下一个目标
                cur_target = target_iter.get_next_ip_port_v6();
            } else {
                // 如果是最终值
