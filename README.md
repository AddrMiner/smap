...
其他参数含义:不允许生成种子地址, 聚类区域最大抽取数量为1000, 发送冷却时间为5秒

```shell
smap -m ipv6_addrs_gen -b 10m -f your_path -a budget=500000 -a no_allow_gen_seeds=true -a region_extraction_num=1000 --cool_seconds 5
```
